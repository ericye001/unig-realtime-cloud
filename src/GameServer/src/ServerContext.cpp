...
int MsgConnHandler::HandleMessage(BasePacket& pkt)
{
    ...
    switch (BaseMessage::Type(&pkt))
    {
        ...
        case MsgType::AGENT_CREATE_REQUEST:
        {
            ...
            UniG_MessageQueue::Instance().SeamlessInQueue().Push(pAddAgent);
            break;
        }
        case MsgType::SYN_AGENT_MESSAGE:
        {
            ...
            UniG_MessageQueue::Instance().SeamlessInQueue().Push(pSynAgent);
            break;
        }
        case MsgType::SESSION_CREATE_REQUEST:
        {
            ...
            message->Unpack(&pkt);
            UniG_MessageQueue::Instance().SeamlessInQueue().Push(message);
            break;
        }
        default:
            break;
