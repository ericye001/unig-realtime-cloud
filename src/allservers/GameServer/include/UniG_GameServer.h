...
public:
    ...
    static void PackObject(UniG_GameObject* pSrc, UniG_GameObject* pDest, void* pMsg, int bToSelf);

    static void ClearAgent(UniG_GameObject* pSrc, UniG_GameObject* pDest, void* pMsg, int bToSelf);

    static void ChangeServer(UniG_GameObject* pSrc, UniG_GameObject* pDest, void* pMsg, int bToSelf);

    static void LockObject(UniG_GameObject* pSrc, UniG_GameObject* pDest, void* pMsg, int bToSelf);

    static void DeSearialize(MapPackage& data);
