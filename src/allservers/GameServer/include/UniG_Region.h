...
public:
    ...
    void SetCellInfo(CellInfo* pInfo)
    {
        ...
        if(m_pCellInfo->length > 0)
        {
            ...
            PtrMemCpy(m_pCellInfo->data, pInfo->data, m_pCellInfo->length);
        }
        else
        {
            m_pCellInfo->data = 0;
...
public:
	...
	void	For_Each( const TypeKey& type, Object* pSrc, void* pParam, int nFlag, void (*pfnCallback)(Object*, Object*, void* pParam, int nFlag) );
    void	For_Each( Object* pSrc, void* pParam, int nFlag, void (*pfnCallback)(Object*, Object*, void* pParam, int nFlag) );
...
template<class Vector, class Cell, int nCell, class Object, class Key, class TypeKey, int nType>
void CRegion<Vector, Cell, nCell, Object, Key, TypeKey, nType>::For_Each( const TypeKey& type, Object* pSrc, void* pParam, int nFlag, void (*pfnCallback)(Object*, Object*, void* pParam, int nFlag) )
{
    std::list<Object*> objlist;
	for( int i = 0; i < MAX_MANAGER_GRID_NUM; ++i )
		for( int j = 0; j < MAX_MANAGER_GRID_NUM; ++j )
		{
            ...
            for( it = objlist.begin(); it != objlist.end(); it++)
            {
				pfnCallback(pSrc, *it, pParam, nFlag);
            }
			objlist.clear();
		}
}
...
template<class Vector, class Cell, int nCell, class Object, class Key, class TypeKey, int nType>
void CRegion<Vector, Cell, nCell, Object, Key, TypeKey, nType>::For_Each(Object* pSrc, void* pParam, int nFlag, void (*pfnCallback)(Object*, Object*, void* pParam, int nFlag) )
{
    std::list<Object*> objlist;
	for( int i = 0; i < MAX_MANAGER_GRID_NUM; ++i )
		for( int j = 0; j < MAX_MANAGER_GRID_NUM; ++j )
