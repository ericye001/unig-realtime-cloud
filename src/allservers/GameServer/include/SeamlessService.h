...
private:
    ...
    // this server intersecting MST
    vector<Map2SrvInfo> m_vecIntersectingMST;

    // the adjoining servers of this server
    vector<uint16> m_vecAdjoiningSrvs;

    // the adjoining maps of this server
    vector<uint16> m_vecAdjoiningMaps;
