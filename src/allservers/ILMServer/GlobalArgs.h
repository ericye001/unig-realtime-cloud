...
class CommonArgs_T : public ClassLevelLockable_T<CommonArgs_T>
{
  public:
    ...
    string _logPath;
    string _logPrefix;
    int _acceptLoginServerPort;
    int _acceptGameServerPort;
    int _acceptConsolePort;
    int _acceptRoleServerPort;
    int _maxGameServer;
    int _gameServerStatQueryT;
    int _playerNumBalanceValue;
    int _baseInfoBusPort;
    int _infoBusMaxMsgNum;
    int _infoBusBatchNum;
    int _maxServerLoad;
